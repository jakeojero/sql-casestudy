...
INSERT INTO Products 
		(Id, BrandId, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder,Description)
VALUES  (6, 2, 'OMEN by HP - 15-ce008ca', 'OMEN HP Laptop', 1599.00, 1599.00, 40, 30, 'Work harder, train longer, and rise up to the relentless competition. Equipped with powerful hardware and a venomous design, the OMEN Laptop is ready for the challenge, anytime, anywhere. Go on, stake your claim. Available in both 39.6cm (15.6") and 43.9cm (17.3") screen sizes.');

INSERT INTO Products 
		(Id, BrandId, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder,Description)
VALUES  (7, 2, 'HP Envy 17-u108ca Notebook', 'HP ENVY Notebook', 1338.00, 1338.00, 80, 10, 'Big tasks, big ideas, and big entertainment demand screen size and power that’s up for the job. The ENVY 17 Laptop delivers the combination you need for multitasking and jaw-dropping immersive entertainment with the freedom to leave your desk behind.');
...
INSERT INTO Products 
		(Id, BrandId, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder,Description)
VALUES  (11, 3, 'ASUS ZenBook 3 UX390UA', 'ASUS ZenBook 3', 1919.00, 1900.00, 25, 3, 'To say that ZenBook 3 is a new generation of ZenBook is a huge understatement — it’s ZenBook reimagined for the next era of mobile computing. Every single precision component and every elegantly crafted detail has been completely re-engineered and redesigned to make ZenBook 3 the most sophisticated ZenBook yet. It’s lighter, thinner, stronger, impossibly powerful — and utterly beautiful. Simply, it’s the world’s most incredible laptop. Say hello to ZenBook 3.');
...
INSERT INTO Products 
		(Id, BrandId, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder,Description)
VALUES  (18, 4, 'Lenovo YOGA 910', 'Lenovo Yoga Laptop', 1599.00, 1599.00, 59, 0, 'The Yoga 910 is a sleek and powerful laptop that makes a stylish statement about how you work and play. Its all-metal unibody design and ultrathin bezel catches the eye, while its fast performance, high-definition 4K display and immersive sound inspire your imagination. More than just a laptop, the Yoga 910 understands your lifestyle.');

INSERT INTO Products 
		(Id, BrandId, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder,Description)
VALUES  (19, 4, 'ThinkPad T470', 'Lenovo Thinkpad', 1493.00, 1493.00, 15, 3, 'Light and thin, the ThinkPad T470s is designed to boost productivity, wherever your business takes you. Powered by a high-performance processor and operating system, this rugged laptop boasts an all-day battery life, plenty of storage, and oodles of RAM. It can entertain on the go too—with an up to 14" WQHD display, stereo speakers, and hi-res webcam. All of this, plus the legendary ThinkPad reliability and support.');

INSERT INTO Products 
		(Id, BrandId, ProductName, GraphicName, CostPrice, MSRP, QtyOnHand, QtyOnBackOrder,Description)
VALUES  (20, 4, 'Lenovo Legion Y720', 'Lenovo Gaming Laptop', 1499.00, 1742.00, 22, 3, '15.6" Immersive Gaming Laptop. Be part of the action no matter where you are, thanks to this portable, but powerful, gaming PC. This 15.6” laptop features a stunning resolution with a vibrant IPS display, and immersive sound to match. This beast can handle any game you want to play, even a VR experience, because it’s powered by 7th Gen Intel® Core™ processors and NVIDIA GTX 1060 discrete graphics. Power + portability = perfection. ');
